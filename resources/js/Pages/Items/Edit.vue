...
//propsでコントローラーから受け取ったオブジェクトの各要素の対して、reactive設定しておく
const form = reactive({
    id: props.item.id,
